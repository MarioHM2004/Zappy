...
class Decision(ABC):
    def __init__(self, *, life_weight: int = 0, team_weight: int = 0, view_weight: int = 0, elevation_weight: int = 0, inventory_weight: int = 0) -> None:
...
class ForwardDecision(Decision):
    def __init__(self, *, life_weight: int = 0, team_weight: int = 0, view_weight: int = 0, elevation_weight: int = 0, inventory_weight: int = 0) -> None:
        super().__init__(life_weight=life_weight, team_weight=team_weight, view_weight=view_weight, elevation_weight=elevation_weight, inventory_weight=inventory_weight)
