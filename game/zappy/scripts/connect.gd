...
func _on_connect_btn_pressed() -> void:
	var server_ip: String = get_node("MarginContainer/VBoxContainer/HBoxContainer/ServerIp").get_text()
	var server_port: String = get_node("MarginContainer/VBoxContainer/HBoxContainer2/ServerPort").get_text()
