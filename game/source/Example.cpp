...
void godot::GDExample::_bind_methods()
{
    ...
    ClassDB::add_property("GDExample",
        PropertyInfo(Variant::FLOAT, "amplitude"), "set_amplitude",
        "get_amplitude");
    ...
    ClassDB::add_property("GDExample",
        PropertyInfo(
            Variant::FLOAT, "speed", PROPERTY_HINT_RANGE, "0,20,0.01"),
        "set_speed", "get_speed");
    ADD_SIGNAL(
        MethodInfo("position_changed", PropertyInfo(Variant::OBJECT, "node"),
...
void godot::GDExample::set_amplitude(const double p_amplitude)
{
