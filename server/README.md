...
| | player_move #n X Y\n   | moves the specified player                 | on request | |
| | player_die #n\n        | kills the specified player                 | on request | |
| | incantation_start #n\n | starts incantation on the specified player | on request | |
| | incantation_end #n\n   | ends incantation on the specified player   | on request | |
